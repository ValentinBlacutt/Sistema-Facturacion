        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlertaStockMinimo = table.Column<int>(type: "int", nullable: false, defaultValue: 5),
                    EstaEliminado = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    AlicuotaIVA = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TieneImpuestoInterno = table.Column<bool>(type: "bit", nullable: false),
                    PorcentajeImpuestoInterno = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TienePercepcion = table.Column<bool>(type: "bit", nullable: false),
                    PorcentajePercepcion = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MontoImpuestoInterno = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MontoPercepcion = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
